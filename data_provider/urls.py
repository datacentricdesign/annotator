...
urlpatterns = [
    ...
    path('pre/informed_consent/', views.informed_consent, name='informed_consent_pre'),
    path('pre/upload_sleep_data/<prolific_id>', views.upload_sleep_data, name='upload_sleep_data'),
    path('pre/thanks/', views.thanks, name='thanks_pre'),

    path('main/informed_consent/', views.informed_consent, name='informed_consent_main'),
    ...
    path('main/thanks/', views.thanks, name='thanks_main'),
